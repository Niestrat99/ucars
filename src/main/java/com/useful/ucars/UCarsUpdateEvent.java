...
public class UCarsUpdateEvent extends VehicleUpdateEvent implements Cancellable {
	...
	public UCarsUpdateEvent(Vehicle vehicle, Vector toTravel, Player player, CarDirection dir) {
		super(vehicle);
